...
function typeAhead(search) {
  ...
  searchInput.on("input", function () {
    ...
    _axios2.default.get("/api/search?q=" + this.value).then(function (res) {
      ...
      searchResults.innerHTML = res.data.length ? _dompurify2.default.sanitize(searchResultsHTML(res.data)) : _dompurify2.default.sanitize("<div class=\"search__result\">Sorry, <i>" + _this.value + "</i> returned no search results.</div>");
    }).catch(function (err) {
      console.error(err);
    });
  });
